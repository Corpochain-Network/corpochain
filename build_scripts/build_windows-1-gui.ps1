...
Write-Output "Remove unused @serwisgalena packages to make cache slim"
...
# Remove `packages/gui/node_modules/@serwisgalena` because it causes an error on later `electron-packager` command
#Remove-Item "@serwisgalena" -Recurse -Force
