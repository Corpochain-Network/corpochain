...
@click.group("sim", help="Configure and make requests to a Corpochain Simulator Full Node")
@click.option(
    "-p",
    "--rpc-port",
    help=(
...
@sim_cmd.command("create", help="Guides you through the process of setting up a Corpochain Simulator")
