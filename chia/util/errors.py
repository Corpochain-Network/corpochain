...
class Err(Enum):
    ...
    # ETH Errors
    INVALID_BLOCK_HASH = 145
    INVALID_PARENT_HASH = 146
    INVALID_PREV_RANDAO = 147
    INVALID_BLOCK_NUMBER = 148
    INVALID_EXTRA_DATA_SIZE = 149
    INVALID_WITHDRAWALS_COUNT = 150
    INVALID_WITHDRAWAL_INDEX = 151
    INVALID_WITHDRAWAL_VALIDATOR_INDEX = 152
    INVALID_WITHDRAWAL_ADDRESS = 153
    INVALID_WITHDRAWAL_AMOUNT = 154
    
    PAYLOAD_INVALIDATED = 155
    PAYLOAD_NOT_VALIDATED = 156
    PAYLOAD_SIDECHAIN = 157
