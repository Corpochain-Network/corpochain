...
class Err(Enum):
    ...
    # ETH Errors
    TIMESTAMP_TOO_FAR_IN_FUTURE = 145
    TIMESTAMP_TOO_FAR_IN_PAST = 146
    INVALID_BLOCK_HASH = 147
    INVALID_PARENT_HASH = 148
    INVALID_PREV_RANDAO = 149
    INVALID_BLOCK_NUMBER = 150
    INVALID_EXTRA_DATA_SIZE = 151
    INVALID_WITHDRAWALS_COUNT = 152
    INVALID_WITHDRAWAL_INDEX = 153
    INVALID_WITHDRAWAL_VALIDATOR_INDEX = 154
    INVALID_WITHDRAWAL_ADDRESS = 155
    INVALID_WITHDRAWAL_AMOUNT = 156
    
    PAYLOAD_INVALIDATED = 157
    PAYLOAD_NOT_VALIDATED = 158
    PAYLOAD_SIDECHAIN = 159
