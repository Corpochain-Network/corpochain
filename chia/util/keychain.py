...
DEFAULT_USER = f"user-corpochain-{CURRENT_KEY_VERSION}"  # e.g. user-corpochain-1.8
DEFAULT_SERVICE = f"corpochain-{DEFAULT_USER}"  # e.g. corpochain-user-corpochain-1.8
MAX_KEYS = 100
