...
# the output will be printed to your corpochain root path, e.g. ~/.corpochain/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.corpochain/mainnet/profile | less -r

# this will print CPU usage of the corpochain full node main thread at 1 second increments.
# find a time window of interest and analyze the profile file (which are in pstats format).

# for example:

#   python chia/utils/profiler.py ~/.corpochain/mainnet/profile 10 20
