...
if [ -z "$VIRTUAL_ENV" ]; then
  echo "This requires the start-gui.sh python virtual environment."
...
GUI_BUILD_PATH="${SCRIPT_DIR}/corpochain-gui/packages/gui/build/electron/main.js"
